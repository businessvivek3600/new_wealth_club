...
class YoutubePlayerValue {
  ...
  YoutubePlayerValue({
    ...
    warningLog('YoutubePlayerValue',
        'This class is deprecated and will be removed in future versions. Use YoutubePlayerValue instead.');
  }
...
class YoutubePlayerController extends ValueNotifier<YoutubePlayerValue> {
  ...
  YoutubePlayerController({
    ...
    warningLog('YoutubePlayerController $initialVideoId',
        'This class is deprecated and will be removed in future versions. Use YoutubePlayerController instead.');
  }
  ...
  static YoutubePlayerController? of(BuildContext context) {
    warningLog(
        ...
        'YoutubePlayerController.of     ${context.dependOnInheritedWidgetOfExactType<InheritedYoutubePlayer>()?.controller}',
        'This method is deprecated and will be removed in future versions. Use YoutubePlayerController.of instead.');
    return context
